...
| Take a bucket off the roadmap | Timeline view → hover the row → click `⊘` (drops to medium priority, keeps the bucket) |
| Put it back on the roadmap | Buckets view → click `⊘` on the bucket header |
